        ...
        create: function(opt, root) {
            ...
            $.each(opt.items, function(key, item){
                ...
                if (typeof item == "string") {
                    $t.addClass('context-menu-separator not-selectable divider');
                    ...
                    switch (item.type) {
                        ...
                        case 'sub':
                            $('<a href="#"></a>').html(item._name || item.name).appendTo($t);
                            item.appendTo = item.$node;
                            item.className = 'dropdown-menu'
                            op.create(item, root);
                            $t.data('contextMenu', item).addClass('context-menu-submenu dropdown-submenu');
                            item.callback = null;
                            break;
                    ...
                    // add icons
                    if (item.icon) {
                        var icon = $('<i/>').addClass('icon-' + item.icon);
                        $t.children(':first').prepend(' ').prepend(icon);
                    }
                }
