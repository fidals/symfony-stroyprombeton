...
namespace App\AdminBundle\Extension;
 ...
 * Используется только в Админке по урлу /admin/editproducts
...
class TableGear
{
    ...
    public function getContent()
    {
        $args = array(
            ...
            'productRepository' => $this->container->get('doctrine')->getRepository('AppMainBundle:Product'),
