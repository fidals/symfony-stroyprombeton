 ...
 * @Gedmo\TreeClosure(class="App\MainBundle\Entity\ServiceClosure")
 * @ORM\Table(name="services")
 * @ORM\Entity(repositoryClass="App\MainBundle\Entity\Repository\ServiceRepository")
 *
 */
class Service
{
    ...
    public function addClosure(ServiceClosure $closure)
    {
